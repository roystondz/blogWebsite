...
const HexagonLoader = ({ darkMode = false }) => {
    return (
      <div className={`socket ${darkMode ? 'dark' : ''}`}>
      <div className="gel center-gel">
        <div className="hex-brick hex-h1"></div>
        <div className="hex-brick hex-h2"></div>
        <div className="hex-brick hex-h3"></div>
      </div>
